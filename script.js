document.addEventListener('DOMContentLoaded', () => {
    ...
    const drawImage = (data) => {
        ...
        // Get the first alphabet of beneficiary name
        ...
        // Right aligned values (CHANGE: Color to textColorLight)
        ctx.textAlign = 'right';
        ctx.font = fontValue; // Apply fontValue to these values as well
        ctx.fillStyle = textColorLight; // CHANGE: Values color to textColorLight
